...
import { ChangeSubscriptionRequestData } from "../../store/artist-profile.model";
...
export function ChangeSubscriptionModal() {
  ...
  const isChangeSubscriptionModalOpen = useSelector(artistProfileSelectors.isChangeSubscriptionModalOpen);
  const isSubscriptionChangingLoading = useSelector(artistProfileSelectors.isSubscriptionChangingLoading);
  ...
  const closeChangeSubscriptionModal = () => dispatch(artistProfileActions.closeChangeSubscriptionModal());
  const getUserCreditCards = () => dispatch(userActions.getUserCreditCards());
  const changeSubscription = (request: ChangeSubscriptionRequestData) => dispatch(artistProfileActions.changeSubscription(request));
