...
import { EditedPlaylistRequest, GetPlaylistsRequest, PlaylistFullResponseData, PlaylistInfoResponseData } from "./playlist.model";

export default class PlaylistService {
    static async getPlaylistsByListenerId(listenerId: string, request: GetPlaylistsRequest): Promise<AxiosResponse<Array<PlaylistInfoResponseData>>> {
        return await api.get<Array<PlaylistInfoResponseData>>(`/playlist/playlists/${listenerId}`, { params: { ...request } });
    }
